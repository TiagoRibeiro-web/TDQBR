...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* Estilo para os expanders dos slides */
    .streamlit-expanderHeader {
        font-size: 16px !important;
        font-weight: 600 !important;
    }
    
    /* Estilo para o conteúdo markdown dos slides */
...
def main():
    ...
    if q == 'Slides':
        ...
        if slides:
            ...
            # Exibe cada seção em um expander com formatação adequada
            for secao_key, secao in slides.get('secoes', {}).items():
                ...
                with st.expander(f"{titulo_secao}", expanded=True):
                    # Renderiza o conteúdo como markdown para melhor formatação
            ...
            for secao_key, secao in slides.get('secoes', {}).items():
                ...
                conteudo = secao.get('conteudo', '')
                # Remove marcação markdown para texto puro
